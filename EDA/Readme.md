...
La presentación [“Statistics for Hackers”](https://speakerdeck.com/jakevdp/statistics-for-hackers) de Jake VanderPlas propone que muchos conceptos estadísticos tradicionales (p-valores, intervalos de confianza, tests, etc.) pueden abordarse de forma más intuitiva y práctica usando simulación computacional si sabes programar en Python; con solo escribir bucles puedes explorar problemas estadísticos complejos. 

En esos principios basamos la clase de hoy. A través de ejemplos como lanzar monedas o comparar medias entre grupos, introduciremos enfoques fundamentales basados en muestreo: simulación directa, shuffling (permuta de etiquetas) y bootstrapping, mostrando cómo estos métodos permiten estimar distribuciones de muestreo y evaluar hipótesis sin recurrir exclusivamente a fórmulas clásicas, enfatizando siempre la importancia de plantear bien la pregunta y entender los datos. Se ven así, variables continuas (densidad vs probabilidad, uniforme y normal, histogramas/KDE), Teorema Central del Límite (bootstrapping, convergencia), distribuciones χ² y t-Student, e introducción a inferencia estadística (hipótesis, p-valor, test t).
Los materiales que utilizaremos son:
- [Presentación](https://docs.google.com/presentation/d/1cKT9HuJJfoktBuWXva2iKrOZUZwocwovc0EezFE0yEU/edit?slide=id.p1#slide=id.p1)
- [“Statistics for Hackers”](https://speakerdeck.com/jakevdp/statistics-for-hackers) de Jake VanderPlas
- NOTEBOOKS de explicación con ejemplos:
  - 4A - Probabilidad: [Original](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/04_A___Probabilidad_Sin_Resolver.ipynb) | [Resuelto](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/04_A___Probabilidad_Resuelto.ipynb)
  - 5A - Probabilidad: [Original](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/05_A___PROBLEMAS_Probabilidad_Sin_Resolver.ipynb) | [Resuelto](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/05_A___PROBLEMAS_Probabilidad_Resuelto.ipynb)
  - 6A - Statistics for Hackers: [Original](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/06_1___Explicaci%C3%B3n_Statistics_for_Hackers.ipynb) | [Resuelto](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/06_1___Explicaci%C3%B3n_Statistics_for_Hackers_Sin_Resolver.ipynb)
  - 6B - Ejercicio campaña: [Notebook](https://colab.research.google.com/github/JotaBlanco/TheValley/blob/main/EDA/04-probabilidad/06_2___Ejercicio_Campaign.ipynb)
